...
describe("OklchColorInput", () => {
  ...
  describe("Rendering", () => {
    it("should render the component correctly", () => {
      render(<OklchColorInput value={defaultColor} onColorChange={mockOnColorChange} />);
  ...
  describe("Variants", () => {
    it("should handle different initial color values", () => {
      ...
      render(<OklchColorInput value={redColor} onColorChange={mockOnColorChange} />);
    ...
    it("should handle colors with different alpha values", () => {
      ...
      render(<OklchColorInput value={transparentColor} onColorChange={mockOnColorChange} />);
    ...
    it("should handle colors with extreme OKLCH values", () => {
      ...
      render(<OklchColorInput value={extremeColor} onColorChange={mockOnColorChange} />);
  ...
  describe("Props Forwarding", () => {
    it("should use the provided value prop as initial color", () => {
      ...
      render(<OklchColorInput value={customColor} onColorChange={mockOnColorChange} />);
    ...
    it("should handle value prop changes", async () => {
      const { rerender } = render(
        <OklchColorInput value={defaultColor} onColorChange={mockOnColorChange} />
      );
      
      expect(findByTextContent("Hue: 180°")).toBeInTheDocument();
      
      const newColor = new Color("oklch", [0.5, 0.3, 60], 0.7);
      rerender(<OklchColorInput value={newColor} onColorChange={mockOnColorChange} />);
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle NaN values in color components", () => {
      ...
      expect(() => {
        render(<OklchColorInput value={achromaticColor} onColorChange={mockOnColorChange} />);
      }).not.toThrow();
    ...
    it("should handle colors outside sRGB gamut", () => {
      ...
      expect(() => {
        render(<OklchColorInput value={wideGamutColor} onColorChange={mockOnColorChange} />);
      }).not.toThrow();
  ...
  describe("Performance", () => {
    it("should not cause unnecessary re-renders", () => {
      ...
      const TestWrapper = ({ value }: { value: Color }) => {
        renderSpy();
        return <OklchColorInput value={value} onColorChange={mockOnColorChange} />;
      };
