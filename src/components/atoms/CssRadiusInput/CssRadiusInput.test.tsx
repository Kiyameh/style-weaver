...
describe("CssRadiusInput", () => {
  ...
  describe("Rendering", () => {
    it("should render the component correctly", () => {
      render(<CssRadiusInput value={defaultRadius} onRadiusChange={mockOnRadiusChange} />);
    ...
    it("should render preview box", () => {
      const { container } = render(<CssRadiusInput value={defaultRadius} onRadiusChange={mockOnRadiusChange} />);
  ...
  describe("Variants", () => {
    it("should handle different initial radius values", () => {
      ...
      render(<CssRadiusInput value={customRadius} onRadiusChange={mockOnRadiusChange} />);
    ...
    it("should handle different CSS units (px, rem, em, %)", () => {
      const units: Array<{ value: number; unit: CssRadiusValue["unit"]; expectedLabel: string }> = [
      ...
      units.forEach(({ value, unit, expectedLabel }) => {
        const { unmount } = render(
          <CssRadiusInput value={{ value, unit }} onRadiusChange={mockOnRadiusChange} />
        );
        
        expect(screen.getByText(new RegExp(expectedLabel.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'), "i"))).toBeInTheDocument();
    ...
    it("should handle zero radius value", () => {
      render(<CssRadiusInput value={{ value: 0, unit: "px" }} onRadiusChange={mockOnRadiusChange} />);
    ...
    it("should handle maximum radius value", () => {
      render(<CssRadiusInput value={{ value: 100, unit: "px" }} onRadiusChange={mockOnRadiusChange} />);
  ...
  describe("Functionality", () => {
    it("should call onRadiusChange when slider value changes", () => {
      ...
      expect(mockOnRadiusChange).toHaveBeenCalledWith({ value: 16, unit: "px" });
    ...
    it("should call onRadiusChange when unit changes", () => {
      ...
      expect(mockOnRadiusChange).toHaveBeenCalledWith({ value: 8, unit: "rem" });
      expect(mockOnRadiusChange).toHaveBeenCalledTimes(1);
    });

    it("should update internal state when value prop changes", async () => {
      const { rerender } = render(
        <CssRadiusInput value={defaultRadius} onRadiusChange={mockOnRadiusChange} />
      );
      
      expect(screen.getByText(/Border Radius: 8px/i)).toBeInTheDocument();
      
      rerender(
        <CssRadiusInput value={{ value: 24, unit: "px" }} onRadiusChange={mockOnRadiusChange} />
      );
    ...
    it("should handle slider interaction correctly", () => {
      ...
      expect(mockOnRadiusChange).toHaveBeenCalledWith({ value: 32, unit: "px" });
      
      fireEvent.change(slider, { target: { value: "50" } });
      expect(mockOnRadiusChange).toHaveBeenCalledWith({ value: 50, unit: "px" });
  ...
  describe("Accessibility", () => {
    ...
    it("should have unique IDs for form controls", () => {
      const { container } = render(
        <>
          <CssRadiusInput value={defaultRadius} onRadiusChange={mockOnRadiusChange} />
          <CssRadiusInput value={{ value: 16, unit: "rem" }} onRadiusChange={mockOnRadiusChange} />
        </>
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle negative values", () => {
      ...
      expect(mockOnRadiusChange).toHaveBeenCalledWith({ value: -5, unit: "px" });
    });
    ...
    it("should handle decimal values with appropriate step", () => {
      ...
      expect(mockOnRadiusChange).toHaveBeenCalledWith({ value: 2.3, unit: "rem" });
    });
    ...
    it("should handle rapid consecutive changes", () => {
      ...
      expect(mockOnRadiusChange).toHaveBeenLastCalledWith({ value: 40, unit: "px" });
    });
  });
  ...
  describe("Visual Preview", () => {
    ...
    it("should show preview with correct inline styles", () => {
      const { container } = render(
        <CssRadiusInput value={{ value: 16, unit: "px" }} onRadiusChange={mockOnRadiusChange} />
      );
      
      const previewBox = container.querySelector('[style*="border-radius"]');
      expect(previewBox).toHaveAttribute("style");
      expect(previewBox?.getAttribute("style")).toContain("border-radius: 16px");
    });
  });
  ...
  describe("Label Formatting", () => {
    it("should format integer values without decimals", () => {
      ...
      expect(screen.getByText(/Border Radius: 16px/i)).toBeInTheDocument();
      expect(screen.queryByText(/Border Radius: 16\.00px/i)).not.toBeInTheDocument();
    });
    ...
    it("should display correct unit in label", () => {
      const units: Array<{ value: CssRadiusValue; expectedLabel: string }> = [
        { value: { value: 8, unit: "px" }, expectedLabel: "Border Radius: 8px" },
        { value: { value: 1, unit: "rem" }, expectedLabel: "Border Radius: 1.00rem" },
        { value: { value: 2, unit: "em" }, expectedLabel: "Border Radius: 2.00em" },
        { value: { value: 50, unit: "%" }, expectedLabel: "Border Radius: 50%" },
      ];
