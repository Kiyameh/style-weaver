...
const FakeDashboard = ({ className, ...props }: FakeDashboardProps) => {
	...
	const containerClass = useMemo(() => {
		return className ? `${s.dashboard} ${className}` : s.dashboard;
	}, [className]);

	// Verificar disponibilidad de colores para usar en estilos inline
	...
	return (
		<div {...props} className={containerClass} style={themeStyles as React.CSSProperties}>
			{/* Header */}
			<header className={s.header}>
				...
				<div className={s.headerActions}>
					<Button variant="ghost" style={{ boxShadow: "var(--shadow-sm)" }}>
						<Bell size={20} />
					</Button>
					<Button variant="ghost" style={{ boxShadow: "var(--shadow-sm)" }}>
						<Settings size={20} />
				...
				<div className={s.mainContent}>
					...
					<section className={s.section}>
						...
						<div className={s.alertsSection}>
							{hasInfo && (
								<Alert variant="info" title="Information" icon={<Info size={20} />}>
				...
				<aside className={s.sidebar}>
					...
					<section className={s.section}>
						<div className={s.sectionHeader}>
							...
							<Chip label="5" variant="primary" style={{ boxShadow: "var(--shadow-sm)" }} />
						</div>
